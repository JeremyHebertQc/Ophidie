...
void Menu::initHomeMenu()
{
	...
	addText(12, "Credits: J�r�my H�bert, Vincent Gagnon, F�lix-Antoine Lacroix & Nathan Bricault", sf::Vector2f(_window->getSize().y - 0.97 * _window->getSize().y, _window->getSize().y - 0.05 * _window->getSize().y), AlignmentLeft, 255, 255, 255);
